    ...
    class WebGetter
    {
        ...
        public async void GetAppointments()
        {
            ...
            var content = await GetContent(
                $"https://burghquayregistrationoffice.inis.gov.ie/Website/AMSREG/AMSRegWeb.nsf/(getAppsNear)?readform&cat=All&sbcat=All&typ=New&k={K}&p={P}&_=1632080630277",
            ...
            if (content == "" || parsed["empty"].ToString() == "TRUE")
            {
                await GetNewSession();
                return;
            }
